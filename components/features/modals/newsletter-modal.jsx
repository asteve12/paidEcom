        ...
        <form action="#">
          <div className="input-group ">
            <input
              ...
              ref={(el) => {
                if (el) {
                  el.style.setProperty('border-radius', '3rem 0 0 3rem', 'important');
                }
              }}
              type="email"
            ...
            />
            <input
              style={{ fontSize: '16px', border: 'none', background:'black' }}
              ref={(el) => {
                if (el) {
                  el.style.setProperty('border-radius', '0 3rem 3rem 0 ', 'important');
                }
              }}
