...
function ShopboxedSlider() {
  ...
  const products = !loading && data.products.data;
  const totalPage = !loading
    ? parseInt(data.products.total / perPage) +
      (data.products.total % perPage ? 1 : 0)
    : 1;
  useEffect(() => {
    console.log("Wow - min changed", query);
    // inner function
    async function getProducts(parametrs) {
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-9 main-content">
            <OwlCarousel
              adClass="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light mb-2"
              options={{
                nav: false,
              }}
            >
